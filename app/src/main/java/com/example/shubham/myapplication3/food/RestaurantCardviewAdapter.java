...
public class RestaurantCardviewAdapter extends RecyclerView.Adapter<RestaurantCardviewAdapter.RestaurantViewHolder> {

    private List<Restaurant> restaurantList;
    private Activity activity;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public RestaurantCardviewAdapter(MainRestaurant mainRestaurant, List<Restaurant> restaurantList) {
            this.restaurantList = restaurantList;
            this.activity = mainRestaurant;
    }

    public RestaurantCardviewAdapter(RecentlyViewedRestaurants recentlyViewedRestaurants, List<Restaurant> restaurantList) {
        this.restaurantList = restaurantList;
    }
