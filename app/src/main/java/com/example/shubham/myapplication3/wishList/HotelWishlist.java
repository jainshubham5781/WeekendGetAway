 ...
 */
public class HotelWishlist extends ActionBarActivity {
    private static final String TAG = HotelWishlist.class.getSimpleName();
    ...
    private HotelWishlistCardviewAdapter restaurantCardviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantCardviewAdapter = new HotelWishlistCardviewAdapter(this, hotelLists);
...
//        }));
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        Toast.makeText(HotelWishlist.this, "A-Z Sorted", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        hotelLists.clear();
                        hotelLists.addAll(sortedList);
                        Toast.makeText(HotelWishlist.this, "Z-A Sorted", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                        break;
                    case 3:
                        ...
                        hotelLists.clear();
                        hotelLists.addAll(sortedList);
                        Toast.makeText(HotelWishlist.this, "Sorted by Rating", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                    ...
                    case 4:
                        ...
                        Toast.makeText(HotelWishlist.this, "Custom", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                          text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                          filter(text1);
                          break;
    ...
    private void fetch(){
        ...
        final String url = "http://172.16.110.69/laravel/public/appHotelsWishlist"+"?email="+user_email+"&"+"id=";
    ...
    public void changelocation(int position){
        ...
        filterlist.clear();
        final String url1 = "http://172.16.110.69/laravel/public/appHotelFilterWishlist"+"?email="+user_email+"&"+"id="+position1;
    ...
    public void openDetail(View itemView) {
        ...
        Intent intent = new Intent(HotelWishlist.this, HotelDetailsTabsFragementActivity.class);
        intent.putExtra("name", restaurant.getName());
        intent.putExtra("id", restaurant.getId());
        SharedPreferences pref = getSharedPreferences("USERID", 0);
        String user_email = pref.getString("user", null);
        if(user_email != null)
            addToRecentlyViewedHotels(user_email, restaurant.getId());
    ...
    private void addToRecentlyViewedHotels(String email, int mid){
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(HotelWishlist.this,ress,Toast.LENGTH_SHORT).cancel();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error){
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(HotelWishlist.this, "Check Your Network Connection", Toast.LENGTH_SHORT);
    ...
    public void hotelHeartClickHandler(View v){
        ...
        String user_email = pref.getString("user", null);
        if(user_email == null)
            Toast.makeText(HotelWishlist.this,"LogIn to Add to Wishlist",Toast.LENGTH_SHORT).show();
        else {
