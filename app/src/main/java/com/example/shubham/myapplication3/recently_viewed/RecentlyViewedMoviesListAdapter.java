 ...
 */
public class RecentlyViewedMoviesListAdapter extends BaseAdapter{
    private Activity activity;
    private LayoutInflater inflater;
    private List<MovieList> movieLists;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
    public RecentlyViewedMoviesListAdapter(Activity activity, List<MovieList> movieLists)
    {
...
//        favourites.addAll(((MainMovies)this.activity).getList1());
