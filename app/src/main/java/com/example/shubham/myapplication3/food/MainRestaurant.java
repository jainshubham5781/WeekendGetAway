 ...
 */
public class MainRestaurant extends ActionBarActivity {
    private static final String TAG = MainRestaurant.class.getSimpleName();
    ...
    private RestaurantCardviewAdapter restaurantCardviewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurantCardviewAdapter = new RestaurantCardviewAdapter(this,restaurantLists);
...
//        }));
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (position) {
                    ...
                    case 1:
                        ...
                        Toast.makeText(MainRestaurant.this, "A-Z Sorted", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        restaurantLists.clear();
                        restaurantLists.addAll(sortedList);
                        Toast.makeText(MainRestaurant.this, "Z-A Sorted", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                        break;
                    case 3:
                        ...
                        restaurantLists.clear();
                        restaurantLists.addAll(sortedList);
                        Toast.makeText(MainRestaurant.this, "Sorted by Rating", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                    ...
                    case 4:
                        ...
                        Toast.makeText(MainRestaurant.this, "Custom", Toast.LENGTH_SHORT).show();
                        restaurantCardviewAdapter.notifyDataSetChanged();
                          text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                          filter(text1);
                          break;
    ...
    private void fetch(){
        final String url = "http://172.16.110.69/laravel/public/appRestaurants";
        arraylist.clear();
        restaurantLists.clear();
        sortedList.clear();
        filterlist.clear();
    ...
    public void changelocation(int position){
        ...
        filterlist.clear();
        final String url1 = "http://172.16.110.69/laravel/public/appRestaurantFilter"+"?id="+position1;
    ...
    public void openDetail(View itemView) {
        ...
        Intent intent = new Intent(MainRestaurant.this, RestaurantDetailsTabsFragementActivity.class);
    ...
    private void addToRecentlyViewedRestaurants(String email,int mid){
        final String url = "http://weekendaway.esy.es/appAddToRecentlyViewedRestaurants";
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MainRestaurant.this,ress,Toast.LENGTH_SHORT).cancel();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
            ...
            public void onErrorResponse(VolleyError error){
                VolleyLog.d(TAG, "Error: " + error.getMessage());
                Toast.makeText(MainRestaurant.this, "Check Your Network Connection", Toast.LENGTH_SHORT);
    ...
    public void restaurantHeartClickHandler(View v){
        ...
        String user_email = pref.getString("user", null);
        if(user_email == null)
            Toast.makeText(MainRestaurant.this,"LogIn to Add to Wishlist",Toast.LENGTH_SHORT).show();
        else {
