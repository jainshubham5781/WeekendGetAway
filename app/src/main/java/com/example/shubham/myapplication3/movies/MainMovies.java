...
import com.example.shubham.myapplication3.adapter.CustomListAdapter;
...
/**
 * Created by Shubham on 25-09-2015.
 */
public class MainMovies extends ActionBarActivity {

    private static final String TAG = MainMovies.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomListAdapter(this, movieLists);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 1:
                        ...
                        Toast.makeText(MainMovies.this, "A-Z Sorted", Toast.LENGTH_SHORT).show();
                    ...
                    case 2:
                        ...
                        movieLists.clear();
                        movieLists.addAll(sortedList);
                        Toast.makeText(MainMovies.this, "Z-A Sorted", Toast.LENGTH_SHORT).show();
                        adapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                    ...
                    case 3:
                        ...
                        movieLists.clear();
                        movieLists.addAll(sortedList);
                        Toast.makeText(MainMovies.this, "Sorted by Rating", Toast.LENGTH_SHORT).show();
                        adapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
                    ...
                    case 4:
                        ...
                        Toast.makeText(MainMovies.this, "Custom", Toast.LENGTH_SHORT).show();
                        adapter.notifyDataSetChanged();
                        text1 = inputSearch.getText().toString().toLowerCase(Locale.getDefault());
                        filter(text1);
    ...
    private void fetchdata(){
       ...
       // String url = "http://172.16.105.47/laravel/public/appmoviesfilter"+"?id=";
        String url = "http://172.16.110.69/laravel/public/appmoviesfilter"+"?id=";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            if(gps.canGetLocation()) {
                ...
                if (user_email == null)
                    Toast.makeText(MainMovies.this, "Please LogIn First", Toast.LENGTH_SHORT).show();
                else {
                    ...
                    JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, loc_url, new JSONObject(params),
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    Log.d(TAG, response.toString());
                                    try {
                                        Toast.makeText(MainMovies.this, response.getString("msg"), Toast.LENGTH_LONG).cancel();
                        ...
                        public void onErrorResponse(VolleyError error) {
                            VolleyLog.d(TAG, "Error: " + error.getMessage());
                            Toast.makeText(MainMovies.this, "Check Your Network Connection", Toast.LENGTH_SHORT);
                        }
                    });
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                Intent intent = new Intent(MainMovies.this, MovieDetailsTabsFragementActivity.class);
...
//                intent.putExtra("movie_location", movie.getLocation());
    ...
    public void heartClickHandler(View v){
        ...
        String user_email = pref.getString("user", null);
        if(user_email == null)
            Toast.makeText(MainMovies.this,"LogIn to Add to Wishlist",Toast.LENGTH_SHORT).show();
        else {
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(MainMovies.this,ress,Toast.LENGTH_SHORT).cancel();
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
...
// spinner of change location
    public void changelocation(int position){
        ...
        filterlist.clear();
        final String url1 = "http://172.16.110.69/laravel/public/appmoviesfilter"+"?id="+position1;
